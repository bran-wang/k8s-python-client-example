    ...
    spec:
      ...
      - name: peer1-org2-f-1 
        ...
        - name: CORE_PEER_PROFILE_ENABLED
          value: "false"
        - name: CORE_PEER_ID
          value: peer1.org2-f-1
        - name: CORE_PEER_ADDRESS
          value: peer1.org2-f-1:7051
       # - name: CORE_PEER_CHAINCODELISTENADDRESS
       #   value: peer1.org2-f-1:7052
        ...
        volumeMounts:
         ...
         - mountPath: /etc/hyperledger/fabric/msp 
           ...
           subPath: peers/peer1.org2-f-1/msp
         - mountPath: /etc/hyperledger/fabric/tls
           name: certificate
           #subPath: crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/
           subPath: peers/peer1.org2-f-1/tls
         - mountPath: /var/hyperledger/production
           name: certificate
           subPath: peers/peer1.org2-f-1/production
