      ...
      - name: orderer0-ordererorg-f-1
        ...
        volumeMounts:
         - mountPath: /var/hyperledger/orderer/msp 
           ...
           subPath: orderers/orderer0.ordererorg-f-1/msp
         - mountPath: /var/hyperledger/orderer/tls
           name: certificate
           #subPath: crypto-config/ordererOrganizations/example.com/orderers/orderer.example.com/tls/
           subPath: orderers/orderer0.ordererorg-f-1/tls
         - mountPath: /var/hyperledger/orderer/orderer.genesis.block
           name: certificate
           subPath: genesis.block
         - mountPath: /var/hyperledger/production
           name: certificate
           subPath: orderers/orderer0.ordererorg-f-1/production
      volumes:
       - name: certificate
         persistentVolumeClaim:
             claimName: {{clusterName}}-ordererorg-f-1-pv
           #path: /opt/share
         #persistentVolumeClaim:
         #  claimName: nfs
